...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'terarangerone' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/ProjectDrive16_17/Sensor/install/${idir}'.  Ask the maintainer 'Luis Rodrigues <luis.rodrigues@terabee.com>' to fix it.")
    endif()
