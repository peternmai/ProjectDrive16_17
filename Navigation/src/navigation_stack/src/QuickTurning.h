...
static const BoxCoordinates FORWARD_LEFT_BOX   = {-0.46, 0.3, 0, 0.46};
static const BoxCoordinates FORWARD_RIGHT_BOX  = {-0.3, 0.46, 0, 0.46};
static const BoxCoordinates BACKWARD_LEFT_BOX  = {-0.46, 0.3, -0.46, 0};
static const BoxCoordinates BACKWARD_RIGHT_BOX = {-0.3, 0.46, -0.46, 0};
