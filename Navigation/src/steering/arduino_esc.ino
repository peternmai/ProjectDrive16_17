...
void setup(){
 ...
 // electronicSpeedController.write(0);
 // electronicSpeedController.write(180);
  delay(1000);
...
void loop(){
  ...
  steeringServo.write(90);  //Turns left
  delay(1000);
  steeringServo.write(180); //Turns left
  delay(1000);
  steeringServo.write(45); //Turns right
  delay(1000);
  steeringServo.write(0); //Turns right 
  delay(1000);
